    ...
    public void loadAutoPaths(){
       ...
       FenderTwoBallAutoWPs = new Waypoint[] {
        ...
        myAutoContainer = new AutoPose[] {
            ...
            new AutoPose("HighFiveBallAutoWPs", 7.62, 1.76, -90, HighFiveBallAutoWPs, PathPlanner.loadPath("FiveBallHigh", 3.5, 2.0)),
            new AutoPose("HighTwoBallAutoWPs", 6.09, 5.19, 43.78, HighTwoBallAutoWPs, PathPlanner.loadPath("TwoBallHigh", 2.5, 1.0)),
            new AutoPose("HighTwoBallAutoNewWPs", 5.98, 5.13, 42.61, HighTwoBallAutoNewWPs, PathPlanner.loadPath("TwoBallHighNew", 2.5, 1.0))
        };
